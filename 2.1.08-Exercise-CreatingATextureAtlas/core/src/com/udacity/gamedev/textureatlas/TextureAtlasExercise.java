...
public class TextureAtlasExercise extends ApplicationAdapter implements AssetErrorListener {
    ...
    TextureAtlas.AtlasRegion standingRightSprite;
    ...
    public void create() {
        ...
        standingRightSprite = atlas.findRegion(STANDING_RIGHT);
    }
    ...
    public void render() {
        ...
        batch.draw(standingRightSprite,
                0,
                0,
                0,
                0,
                standingRightSprite.getRegionWidth(),
                standingRightSprite.getRegionHeight(),
                1,
                1,
                0);
        batch.end();
